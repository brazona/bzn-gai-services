...
import br.brazona.bzn_exemplo_services_users.domain.model.UserEntity;
...
public class UserDto {
	 ...
	 * @return UserEntity - Retorna objeto modelo com as informações do usuário.
	 */	

	public UserEntity toModel(UserEntity userEntity) {
		return new UserEntity(userEntity.getId(), userEntity.getEmail());
	}
	 ...
	 */	
	public UserEntity toEntity(UserEntity userModel) {
